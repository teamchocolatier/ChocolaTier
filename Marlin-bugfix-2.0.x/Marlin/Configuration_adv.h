 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 1     // Degrees Celsius //EW - changed from 4 to 1
...
// Time can be set by M18 and M84.      120 is normal
...
//#define FWRETRACT
  ...
  #endif
  #define RETRACT_LENGTH 0                // EW - changed retract to 0 Default retract length (positive mm)
