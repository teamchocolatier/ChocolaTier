...
#define CUSTOM_MACHINE_NAME "fOoDaToRy"
...
// :[1, 2, 3, 4, 5, 6]
#define EXTRUDERS 2 //EW - temp changed to 1

// Generally expected filament diameter (1.75, 2.85, 3.0, ...). Used for Volumetric, Filament Width Sensor, etc.
#define DEFAULT_NOMINAL_FILAMENT_DIA 3.0 // EW - not sure what we should use here
 ...
 *     0 : not used
 *     1 : OUR CUSTOM THERM PROFILE 100k thermistor - best choice for EPCOS 100k (4.7k pullup)
 ...
 */
#define TEMP_SENSOR_0 1 //EW 1 is our custo thermister profile
...
#define DUMMY_THERMISTOR_998_VALUE 32
...
#define HEATER_0_MAXTEMP 50 //EW - Changed all to 50C
#define HEATER_1_MAXTEMP 50
#define HEATER_2_MAXTEMP 50
#define HEATER_3_MAXTEMP 50
#define HEATER_4_MAXTEMP 50
#define HEATER_5_MAXTEMP 50
...
#define PIDTEMP //EW - skipping this section for now
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Ultimaker
  #define DEFAULT_Kp 109.9 //22.2
  #define DEFAULT_Ki 21.64 //1.08
  #define DEFAULT_Kd 139.55 //114
 ...
 */
 //EW - Turning off so we can use solenoid even when chocolate is cold
//#define PREVENT_COLD_EXTRUSION
#define EXTRUDE_MINTEMP 10 //Ew - changed from 175 to 10
...
//#define THERMAL_PROTECTION_HOTENDS // EW - TEMP DISABLED Enable thermal protection for all extruders
...
#define Z_MIN_ENDSTOP_INVERTING false // EW - set back to false set to true (https://www.youtube.com/watch?v=G-TwWfUzXpc) set to true to invert the logic of the endstop.
#define X_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING false // set to true to invert the logic of the endstop.
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // EW - set back to false //to true set to true to invert the logic of the probe.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE   { 30, 30, 10, 25 }   //EW - slowed X and Y by a factor of 10// { 300, 300, 10, 25 } //E-double speed
 ...
 */
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN // EW - I am confused about this
 ...
 */
#define FIX_MOUNTED_PROBE //EW - inductive sensor
...
#define XY_PROBE_SPEED 3000//8000 EW - changed to stop binding
...
#define Z_MIN_PROBE_REPEATABILITY_TEST //EW - enabled
...
#define MIN_SOFTWARE_ENDSTOPS //EW - TEMPERALILY DISABLED FOR TESTING
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP     32  // EW - changed to 32 (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
...
//
#define Z_SAFE_HOMING //EW - Enabled to zero z in the middle of the bed
...
//
#define EEPROM_SETTINGS // Enable for M500 and M501 commands EW - Enabled
 ...
 */
#define PRINTCOUNTER //EW - enabled
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIN    32        // LED driving pin on motherboard 4 => D4 (EXP2-5 on Printrboard) / 30 => PC7 (EXP3-13 on Rumba)
  #define NEOPIXEL_PIXELS  9       // Number of LEDs in the strip
